...
const DevPage = () => {
  ...
  return (
    <Layout>
      ...
      <div className="w-full max-w-[700px] mb-10 px-10">
        <OriginMap />
      </div>
      ...
      <div className="w-full mb-10 px-10">
        ...
        <p>
          ...
          ipsum dolor sit amet consectetur adipisicing elit. Adipisci veritatis
          in optio aliquid voluptas minus molestiae provident itaque laborum
          voluptatem nesciunt beatae, numquam dicta vitae reiciendis deleniti
          eius et temporibus.
        </p>
      </div>
